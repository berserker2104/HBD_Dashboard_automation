...
export function CitiesSummary() {
  ...
  // Process Rows: Filter Cities based on search input
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center py-20 gap-3">
        ...
        <Typography className="animate-pulse text-gray-600 font-medium">Loading City Report...</Typography>
      </div>
    );
  }
    ...
    <div className="mt-8 mb-12 px-4 max-w-5xl mx-auto">
      <div className="mb-4">
        ...
        <Typography variant="small" className="text-gray-500">
          Professional view of listing distribution by city.
        </Typography>
      </div>
